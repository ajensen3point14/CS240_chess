...
public class Database {
    ...
    private static final String DB_USERNAME = "adj37";
    private static final String DB_PASSWORD = "V235yxe9!!YoDead";
    ...
    public static synchronized Connection connection() throws DataAccessException {
        if (single_instance == null)
            single_instance = new Database();

        return single_instance.getConnection();
    }
